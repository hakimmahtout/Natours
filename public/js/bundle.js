    ...
    "node_modules/core-js/internals/async-iterator-prototype.js"(exports, module) {
      ...
      if (PassedAsyncIteratorPrototype) {
        ...
        try {
          ...
          if (getPrototypeOf2(prototype3) === Object.prototype) AsyncIteratorPrototype = prototype3;
        } catch (error) {
        }
      }
    ...
    "node_modules/core-js/internals/async-iterator-close.js"(exports, module) {
      ...
      module.exports = function(iterator2, method, argument, reject) {
        try {
          var returnMethod = getMethod(iterator2, "return");
          if (returnMethod) {
            return getBuiltIn("Promise").resolve(call(returnMethod, iterator2)).then(function() {
              method(argument);
            }, function(error) {
              reject(error);
            });
    ...
    "node_modules/core-js/internals/array-from-async.js"(exports, module) {
      ...
      module.exports = function fromAsync(asyncItems) {
        ...
        return new (getBuiltIn("Promise"))(function(resolve) {
          ...
          var iterator2 = usingAsyncIterator ? getAsyncIterator(O, usingAsyncIterator) : new AsyncFromSyncIterator(getIteratorDirect(getIterator(O, usingSyncIterator)));
    ...
    "node_modules/core-js/internals/set-is-disjoint-from.js"(exports, module) {
      ...
      module.exports = function isDisjointFrom(other) {
        ...
        return iterateSimple(iterator2, function(e) {
          if (has(O, e)) return iteratorClose(iterator2, "normal", false);
        }) !== false;
      };
    }
  });
